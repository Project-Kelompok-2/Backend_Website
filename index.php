...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
	...
	<div class="wrapper">
		...
		<div class="preloader flex-column justify-content-center align-items-center">
			<img class="animation__wobble" src="polije.png" alt="AdminLTELogo" height="250" width="250">
		</div>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="" class="brand-link">
				<img src="polije.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
					style="opacity: .8">
				<span class="brand-text font-weight-light">Polije </span>
			</a>
				...
				<div class="container-fluid">
						...
						<div class="col-12 col-sm-6 col-md-3">
							<div class="info-box">
								<span class="info-box-icon bg-info elevation-1"><i
										class="fas fa-temperature-high"></i></span>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title"><i class="icon fas fa-chart-bar"></i> Temperature & Humidity
										Sensor DHT11</h5>
								...
								<div class="card-body">
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="card ">
												<div class="card-header">
													<h3 class="card-title"><i class="fas fa-temperature-high"></i> Speed
														Gauge Temperature</h3>
												</div>
												<div class="card-body">
										...
										<div class="col-sm-6">
											<div class="card">
												<div class="card-header">
													<h3 class="card-title"><i class="fas fa-tint"></i> Speed Gauge
														Humidity</h3>
												</div>
												<div class="card-body">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h5 class="card-title"><i class="fas fa-lightbulb"></i> Light Intensity Sensor LDR
										<i class="fas fa-low-vision"></i> Ultrasonic Distance Sensor HC-SR04</h5>
									<div class="card-tools">
										<button type="button" class="btn btn-tool" data-card-widget="collapse">
											<i class="fas fa-minus"></i>
										</button>
								...
								<div class="card-body">
									<div class="row">
										...
										<div class="col-sm-6">
											...
											<div class="chart">
												<canvas id="chartUltrasonic" height="180"
							...
							<div class="card">
								...
								<div class="card-body">
											...
											<div class="card ">
												...
												<div class="card-body">
													<input type="text" class="sliderLED" name="nLED" value=""
														data-type="single" data-min="0" data-max="9" data-from="0"
														data-step="1" />
												</div>
											</div>
										</div>
									...
									<div class="col-md-4">
										<div class="card ">
											<div class="card-header">
												<h3 class="card-title">
													<i class="fas fa-toggle-off"></i> Fan 1
												</h3>
											</div>
											<div class="card-body">
												<input type="checkbox" onclick="Fan1ONOFF(this)"> ON - OFF
											</div>
										</div>
									</div>
								</div>
								<div class="col-md-4">
									<div class="card ">
										<div class="card-header">
											<h3 class="card-title">
												<i class="fas fa-toggle-off"></i> Fan 2
											</h3>
										</div>
										<div class="card-body">
											<input type="checkbox" onclick="Fan2ONOFF(this)"> ON - OFF
										</div>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-8">
									<div class="card ">
										...
										<div class="card-body">
											<input type="text" class="sliderFAN" name="nFAN" value="" data-type="single"
												data-min="0" data-max="100" data-from="0" data-step="5"
												data-grid="true" />
										</div>
									</div>
								</div>
	...
	<footer class="main-footer">
		<strong>Copyright &copy; 2022 <a href="https://github.com/Project-Kelompok-2/">MOP Green</a>.</strong>
  ...
  -----------------------------------------------------*/
		...
		client.onMessageArrived = function (message) {
            ...
            fetch('http://localhost/iot/index.php', {
              method: 'POST', // or 'PUT'
            //   headers: {
